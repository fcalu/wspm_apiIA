...
from app.api.v1.routes_nba import router as nba_router
from app.api.v1.routes_soccer import router as soccer_router
...
app.include_router(soccer_router, prefix="/api/v1")
